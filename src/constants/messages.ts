export const messages = {
    please_connect: "Please connect your wallet to the Avalanche network to use Jupiter Finance.",
    please_connect_wallet: "Please connect your wallet.",
    try_mint_more: (value: string) => `You're trying to mint more than the maximum payout available! The maximum mint payout is ${value} JUPITER.`,
    ...
    switch_to_ethereum: "Switch to the Avalanche network?",
